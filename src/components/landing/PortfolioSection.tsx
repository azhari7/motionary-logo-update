...
const PortfolioSection = () => (
  <section id="portofolio" className="py-32">
    <div className="container mx-auto px-4">
      ...
      <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
        {videos.map((v, i) => (
          <motion.div key={i} variants={fadeUp} custom={i + 2} className="rounded-xl overflow-hidden border border-border bg-card">
