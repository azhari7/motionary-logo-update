...
const videos = [{
  title: "Edukasi Anak: Sistem Tata Surya",
  style: "Gaya Crayon",
  id: "dQw4w9WgXcQ"
}, {
  title: "Fakta Unik: Rahasia Ikan Koi",
  style: "Gaya Watercolor",
  id: "dQw4w9WgXcQ"
}, {
  title: "Short Story: Misteri Jamur Hutan",
  style: "Digital Art",
  id: "dQw4w9WgXcQ"
}, {
  title: "Promosi Produk: Gadget Review",
  style: "Clean Motion",
  id: "dQw4w9WgXcQ"
}];
const fadeUp = {
...
const PortfolioSection = () => <section id="portofolio" className="py-32">
    <div className="container mx-auto px-4">
      ...
      once: true
        ...
        {videos.map((v, i) => <motion.div key={i} variants={fadeUp} custom={i + 2} className="rounded-xl overflow-hidden border border-border bg-card">
